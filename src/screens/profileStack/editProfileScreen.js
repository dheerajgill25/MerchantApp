    ...
    return (
      <SafeAreaView style={profileStyles.container}>
        ...
        <ScrollView style={{marginBottom: 80}}>
          ...
          <View style={{paddingHorizontal: 22}}>
            <Text style={profileStyles.text_footer}>
              Apt, Building, Gate code etc,
            </Text>
            <View style={profileStyles.action}>
              <TextInput
                placeholderTextColor="#fff"
          ...
          <View style={{paddingHorizontal: 22}}>
            ...
            <View>
              ...
              <View
                ...
                <DropdownComponent
                  title={selectedState?.state_name || 'Please select state'}
          ...
          <View style={{paddingHorizontal: 22}}>
            ...
            <Picker
              ...
              <View
                ...
                <DropdownComponent
                  title={data?.area_code_name ||'Please select area code'}
          ...
          <View style={{paddingHorizontal: 22}}>
            ...
            <View>
              ...
              <View
                ...
                <DropdownComponent
                  title={data?.bussiness_type_name || 'Please select Business type'}
                  dropdownData={businessTypeList}
                  onPress={data => setBusinessType(data.id)}
                  type="bussniessType"
                />
              </View>
            </View>
          ...
          <View style={{paddingHorizontal: 22}}>
            ...
            <View>
              ...
              <View
                ...
                <DropdownComponent
                  title={data?.designation_name || 'Please select designation'}
                  dropdownData={designationList}
                  onPress={data => setDesignation(data.id)}
          ...
          <View style={{paddingHorizontal: 22}}>
            ...
            <View>
              ...
              <View
                ...
                <DropdownComponent
                  title={data?.business_category_name || 'Please select Bussiness Domain'}
                  dropdownData={domainList}
                  onPress={data => setBussinessDomain(data.id)}
          ...
          <View
            ...
            <View
              style={[profileStyles.columnSection, {marginLeft: -10}]}></View>
            <View style={[profileStyles.columnSection, {marginRight: 10}]}>
              <TouchableOpacity
                style={profileStyles.greyButton}
                onPress={() => {
                  onSave();
                }}>
